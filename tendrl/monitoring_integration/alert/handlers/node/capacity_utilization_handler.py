...
class CapacityUtilizationHandler(AlertHandler):

    handles = 'capacity'
    representive_name = 'capacity_utilization_alert'

    def __init__(self):
        AlertHandler.__init__(self)
        self.template = "tendrl.clusters.{cluster_id}.nodes.{host_name}.bricks"
